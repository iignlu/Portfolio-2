...
(function () {
    ...
    var DICT = {
        en: {
            ...
            'work.p4.name': 'Portfolio UI Design',
            'work.p4.desc': 'The Figma prototype I designed before building this site — my first end-to-end design-to-code project.',
            'work.p5.name': 'Plant Watering System',
            'work.p5.desc': 'Mobile UI for an IoT plant monitor — soil-moisture tracking and watering alerts. Built for my HCI course.',
            'work.p6.name': 'Wikipedia Redesign',
            'work.p6.desc': "A UI/UX competition entry modernising Wikipedia's interface, focused on readability and navigation.",
            'work.p7.name': 'Portfolio v1',
            'work.p7.desc': 'My first portfolio, built with vanilla HTML and CSS. Where it all started.',
        ...
        ar: {
            ...
            'work.p4.name': 'تصميم واجهة البورتفوليو',
            'work.p4.desc': 'النموذج الأولي في Figma الذي صمّمته قبل بناء هذا الموقع — أول مشروع لي من التصميم حتى الكود.',
            'work.p5.name': 'نظام ري النباتات',
            'work.p5.desc': 'واجهة جوال لنظام إنترنت أشياء لمراقبة النبات — تتبّع رطوبة التربة وتنبيهات الري. لمقرر تفاعل الإنسان والحاسب.',
            'work.p6.name': 'إعادة تصميم ويكيبيديا',
            'work.p6.desc': 'مشاركة في مسابقة تصميم واجهات لتحديث واجهة ويكيبيديا، بتركيز على سهولة القراءة والتنقّل.',
            'work.p7.name': 'البورتفوليو — الإصدار الأول',
            'work.p7.desc': 'أول بورتفوليو لي، مبني بـ HTML و CSS خام. من هنا بدأت الحكاية.',
