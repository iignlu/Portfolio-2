...
(function () {
    ...
    var DICT = {
        en: {
            ...
            'work.p3.desc': 'A machine-learning model that analyses retinal images to flag early signs of diabetic retinopathy. My capstone project.',
        ...
        ar: {
            ...
            'work.p3.desc': 'نموذج تعلّم آلي يحلّل صور الشبكية لرصد العلامات المبكرة لاعتلال الشبكية السكري. مشروع التخرّج.',
