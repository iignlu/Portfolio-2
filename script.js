...
(function () {
    ...
    var DICT = {
        en: {
            ...
            'work.p2.name': 'Job Radar',
            'work.p2.desc': 'A bot that finds graduate software and data roles across Saudi Arabia and pushes each one to Telegram with an apply link. Bilingual filtering, zero dependencies, runs free on GitHub Actions.',
            'work.p3.name': 'Diabetic Retinopathy Detection',
            'work.p3.desc': 'A machine-learning model that analyses retinal images to flag early signs of diabetic retinopathy. Four-person capstone project, built with Swin Transformer V2.',
            'work.p4.name': 'BookFlow',
            'work.p4.desc': 'An appointment booking app — role-based auth, real-time updates, file attachments and an admin dashboard for managing slots. Built to work through a full-stack project end to end.',
            'work.p5.name': 'Portfolio UI Design',
            'work.p5.desc': 'The Figma prototype I designed before building this site — my first end-to-end design-to-code project.',
            'work.p6.name': 'Plant Watering System',
            'work.p6.desc': 'Mobile UI for an IoT plant monitor — soil-moisture tracking and watering alerts. Built for my HCI course.',
            'work.p7.name': 'Wikipedia Redesign',
            'work.p7.desc': "A UI/UX competition entry modernising Wikipedia's interface, focused on readability and navigation.",
            'work.p8.name': 'Portfolio v1',
            'work.p8.desc': 'My first portfolio, built with vanilla HTML and CSS. Where it all started.',
        ...
        ar: {
            ...
            'work.p2.name': 'رادار الوظائف',
            'work.p2.desc': 'بوت يرصد وظائف البرمجة والبيانات المناسبة لحديثي التخرّج في السعودية ويرسل كل وظيفة إلى تلقرام مع رابط التقديم. فلترة ثنائية اللغة، بدون أي اعتماديات، ويعمل مجانًا على GitHub Actions.',
            'work.p3.name': 'الكشف عن اعتلال الشبكية السكري',
            'work.p3.desc': 'نموذج تعلّم آلي يحلّل صور الشبكية لرصد العلامات المبكرة لاعتلال الشبكية السكري. مشروع تخرّج جماعي من أربعة أفراد، مبني على Swin Transformer V2.',
            'work.p4.name': 'BookFlow — حجز المواعيد',
            'work.p4.desc': 'تطبيق لحجز المواعيد — صلاحيات حسب الدور، وتحديثات فورية، وإرفاق ملفات، ولوحة تحكم لإدارة الأوقات المتاحة. بنيته لأخوض مشروعًا متكاملًا من أوله لآخره.',
            'work.p5.name': 'تصميم واجهة البورتفوليو',
            'work.p5.desc': 'النموذج الأولي في Figma الذي صمّمته قبل بناء هذا الموقع — أول مشروع لي من التصميم حتى الكود.',
            'work.p6.name': 'نظام ري النباتات',
            'work.p6.desc': 'واجهة جوال لنظام إنترنت أشياء لمراقبة النبات — تتبّع رطوبة التربة وتنبيهات الري. لمقرر تفاعل الإنسان والحاسب.',
            'work.p7.name': 'إعادة تصميم ويكيبيديا',
            'work.p7.desc': 'مشاركة في مسابقة تصميم واجهات لتحديث واجهة ويكيبيديا، بتركيز على سهولة القراءة والتنقّل.',
            'work.p8.name': 'البورتفوليو — الإصدار الأول',
            'work.p8.desc': 'أول بورتفوليو لي، مبني بـ HTML و CSS خام. من هنا بدأت الحكاية.',
